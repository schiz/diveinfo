  ...
  $.fn.perfectScrollbar = function (suppliedSettings, option) {
    ...
    return this.each(function () {
      ...
      $this.addClass('ps-container');
          ...
          $("<div class='ps-scrollbar-y-line'></div>").appendTo($this);
      ...
      var $scrollbarX = $("<div class='ps-scrollbar-x'></div>").appendTo($this),
          ...
          scrollbarYHeight = parseInt($scrollbarY.css('height'), 10),
          scrollbarYTop,
      ...
      var updateBarSizeAndPosition = function () {
        ...
        if (containerHeight < contentHeight) {
         ...
         // scrollbarYHeight = getSettingsAdjustedThumbSize(parseInt(13, 10));
